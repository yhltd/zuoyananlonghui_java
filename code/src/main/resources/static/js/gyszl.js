...
$(function () {
    ...
    $('#update-btn').click(function () {
        let rows = getTableSelection('#gyszlTable');
        ...
        $('#update-yfje').val(rows[0].data.yfje);
...
function setTable(data) {
    if ($('#gyszlTable').html != '') {
        $('#gyszlTable').bootstrapTable('load', data);
    }

    $('#gyszlTable').bootstrapTable({
        data: data,
        sortStable: true,
