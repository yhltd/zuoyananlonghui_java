...
$(function () {
    ...
    $('#update-btn').click(function () {
        let rows = getTableSelection('#czqxTable');
        ...
        $('#update-czr').val(rows[0].data.czr);
        $('#update-biao').val(rows[0].data.biao);
        $('#update-czqx').val(rows[0].data.czqx);
        $('#update-sfyx').val(rows[0].data.sfyx);
    });
...
function setTable(data) {
    if ($('#czqxTable').html != '') {
        $('#czqxTable').bootstrapTable('load', data);
    }

    $('#czqxTable').bootstrapTable({
        data: data,
        sortStable: true,
