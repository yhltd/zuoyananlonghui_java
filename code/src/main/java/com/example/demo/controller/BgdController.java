...
//
//        // 生成访问完整数据的URL
//        String dataUrl = serverUrl + "/bgd/contractData/" + contractId;
//
//        return dataUrl;
//    }
//
...
//
//    /**
//     * 返回纯文本格式的完整合同数据（手机扫描后直接显示文本）
//     */
//    @GetMapping(value = "/contractData/{contractId}", produces = "text/plain;charset=UTF-8")
//    public String getContractDataAsText(@PathVariable String contractId) {
//        try {
//            System.out.println("手机端请求合同数据，合同ID: " + contractId);
//
//            // 根据合同ID获取合同详情
...
//                return "未找到合同ID: " + contractId + " 对应的数据";
//            }
//
//            // 构建纯文本格式的完整数据
//            StringBuilder text = new StringBuilder();
//            text.append("=== 合同工艺规程详情 ===\n\n");
//            text.append("合同ID: ").append(contractId).append("\n");
//
//            // 添加基本信息（从第一条记录获取）
//            if (contractDetails.size() > 0) {
//                Map<String, Object> firstProcess = contractDetails.get(0);
//                text.append("业务单位: ").append(firstProcess.get("D")).append("\n");
//                text.append("零件名称: ").append(firstProcess.get("G")).append("\n");
//                text.append("材质: ").append(firstProcess.get("F")).append("\n");
//                text.append("数量: ").append(firstProcess.get("E")).append("\n");
//                text.append("图号: ").append(firstProcess.get("I")).append("\n");
//                text.append("任务号: ").append(firstProcess.get("H")).append("\n\n");
//            }
//
//            text.append("=== 工序列表 ===\n");
//            text.append(String.format("%-4s %-10s %-15s %-8s %-10s %-12s\n",
//                    "序号", "工序名称", "工序内容", "工时", "员工签名", "完工时间"));
//            text.append("------------------------------------------------------------\n");
//
//            for (int i = 0; i < contractDetails.size(); i++) {
//                Map<String, Object> process = contractDetails.get(i);
//                text.append(String.format("%-4d %-10s %-15s %-8s %-10s %-12s\n",
//                        i + 1,
//                        process.get("J") != null ? process.get("J").toString() : "",
//                        process.get("K") != null ? process.get("K").toString() : "",
//                        process.get("L") != null ? process.get("L").toString() : "",
//                        process.get("M") != null ? process.get("M").toString() : "",
//                        process.get("N") != null ? process.get("N").toString() : ""
//                ));
//            }
//
//            text.append("\n=== 统计信息 ===\n");
//            text.append("总工序数: ").append(contractDetails.size()).append("\n");
//
//            // 统计已签名的工序数
//            long signedCount = contractDetails.stream()
//                    .filter(process -> "1".equals(process.get("M")))
//                    .count();
//            text.append("已签名工序: ").append(signedCount).append("\n");
//            text.append("未签名工序: ").append(contractDetails.size() - signedCount).append("\n");
//
//            String result = text.toString();
//            System.out.println("返回的文本数据长度: " + result.length() + " 字符");
//
//            return result;
//        } catch (Exception e) {
//            e.printStackTrace();
