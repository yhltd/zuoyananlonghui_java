    ...
    <style>
        * {
        ...
        .print-page {
            ...
            padding: ${selectedSize === 'A5' ? '25mm 7mm 10mm 7mm' : '10mm'}; /* A5: 进一步减少顶边距以确保明显上移 */
            margin: 0 auto;
            position: relative;
            background: white;
            overflow: hidden;
        ...
        .qrcode-container {
            position: absolute;
            top: ${selectedSize === 'A4' ? '-5mm' : '2mm'}; /* A5: 从3mm减少到2mm，再上移1mm */
            right: 10mm;
            width: 30mm;
            height: auto;
            text-align: center;
        ...
        .main-title {
            ...
            font-weight: bold;
            text-align: center;
            margin: ${selectedSize === 'A4' ? '10mm auto 5mm auto' : '2mm auto 2mm auto'};
            width: 100%;
        }
        ...
        .info-header {
            ...
            border-collapse: collapse;
            border: 1.5px solid #000;
            margin-top: ${selectedSize === 'A4' ? '10mm' : '5mm'};
        }
        .info-header th, .info-header td {
            border: 1px solid #000;
            padding: 2mm 1mm;
