    ...
    <style>
        * {
        ...
        .print-page {
            ...
            padding: ${selectedSize === 'A5' ? '15mm 7mm' : '10mm'}; /* A5: 上下对称15mm, 左右7mm - 符合标准打印习惯 */
            margin: 0 auto;
            position: relative;
            background: white;
            overflow: hidden;
        ...
        .main-title {
            ...
            font-weight: bold;
            text-align: center;
            margin: ${selectedSize === 'A4' ? '10mm auto 5mm auto' : '8mm auto 2mm auto'};
            width: 100%;
        }
