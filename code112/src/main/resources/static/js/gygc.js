    ...
    <style>
        * {
        ...
        .info-header {
            ...
            border-collapse: collapse;
            border: 1.5px solid #000;
            margin-top: ${selectedSize === 'A4' ? '10mm' : (selectedSize === 'A5' ? '5mm' : '5mm')};
        }
    ...
    <div class="print-page">
        ...
        <div class="signature-row">
            <div class="signature-item">
                <div class="signature-label">工艺员:</div>
                <div class="signature-value">${signatureData.gyy || ''}</div>
                <div class="signature-value" style="font-size: 10pt;">${signatureData.gyrq || ''}</div>
            </div>
            <div class="signature-item">
                <div class="signature-label">校对员:</div>
                <div class="signature-value">${signatureData.jdy || ''}</div>
                <div class="signature-value" style="font-size: 10pt;">${signatureData.jdrq || ''}</div>
            </div>
            <div class="signature-item">
                <div class="signature-label">批准:</div>
                <div class="signature-value">${signatureData.pzr || ''}</div>
                <div class="signature-value" style="font-size: 10pt;">${signatureData.pzrq || ''}</div>
            </div>
        </div>
